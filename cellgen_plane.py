...
#This create a padded matrix, with all false values as border. With it, the GoF algorithm works for a flat space
padded = np.pad(cells, pad_width=1, mode='constant', constant_values=False)
